...
class Message{
    ...
    init(senderName : String, receiverName : String , recieverid : String, imageURL: String, senderId: String,notification : String, message: String, date : NSNumber, reciverImageURL: String){
